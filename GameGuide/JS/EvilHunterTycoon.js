...
function NavigationManagement(let) {
    if (let == "Hunter") {
        if (document.getElementById("Hunter1").style.display == "block") {
            document.getElementById("Hunter1").style.display = "none";
            document.getElementById("Hunter2").innerHTML = "=>";
        }
        else if (document.getElementById("Hunter1").style.display == "none") {
            document.getElementById("Hunter1").style.display = "block";
            document.getElementById("Hunter2").innerHTML = "<=";
        }
    }
    if (let == "Index") {
